...
/// </summary>
public class AredflagTrackable : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        if (mTrackableBehaviour.TrackableName.Equals("A"))
        {
            atrackID = 1;
        }
    ...
    void Update()
    {
        if (AredflagTrackable.atrackID == 1 && ShuikuTrackable.shuikutrackID == 1)
        {
                      // shuikutishi.GetComponent<Image>().enabled = true;
            shuiku1.SetActive(true);
            
        }
        else if((BblueflagTrackable.btrackID == 1 || CgreenflagTrackable.ctrackID == 1 || DyellowflagTrackable.dtrackID == 1 || EwhiteflagTrackable.etrackID == 1) && ShuikuTrackable.shuikutrackID == 1)
        {
            shuikutishi.GetComponent<Image>().enabled = true;
        }
        ...
        else if ((AredflagTrackable.atrackID == 1 || CgreenflagTrackable.ctrackID == 1 || DyellowflagTrackable.dtrackID == 1 || EwhiteflagTrackable.etrackID == 1) && NongyeTrackable.nongyetrackID == 1)
        {
        ...
        else if ((AredflagTrackable.atrackID == 1 || BblueflagTrackable.btrackID == 1 || DyellowflagTrackable.dtrackID == 1 || EwhiteflagTrackable.etrackID == 1 ) && VillageTrackable.villagetrackID == 1)
        {
            //  shuikutishi.SetActive(true);
        ...
        else if ((AredflagTrackable.atrackID == 1 || BblueflagTrackable.btrackID == 1 || CgreenflagTrackable.ctrackID == 1 || EwhiteflagTrackable.etrackID == 1) && HuagongchangTrackable.huagongchangtrackID == 1)
        {
        ...
        else if ((AredflagTrackable.atrackID == 1 || BblueflagTrackable.btrackID == 1 || CgreenflagTrackable.ctrackID == 1 || DyellowflagTrackable.dtrackID == 1) && XumuyeTrackable.xumuyetrackID == 1)
        {
